    ...
    switch (sub) {
      case "add":
        const addembed = new EmbedBuilder()
          ...
          .setDescription(`${client.emoji.tick} Successfully added the role: ${role} to  ${username}`);
      ...
      case "remove":
        const removeembed = new EmbedBuilder()
          .setColor(client.config.embedColor)
          .setDescription(`${client.emoji.tick} Successfully removed the role: ${role} from  ${username}`);
