const { EmbedBuilder, PermissionFlagsBits, StringSelectMenuBuilder, ActionRowBuilder, MessageFlags } = require('discord.js');
...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        if (!data) return interaction.reply({ embeds: [embed.setColor('Red').setDescription(config.ticketError)], flags: MessageFlags.Ephemeral }).catch(error => { return });
